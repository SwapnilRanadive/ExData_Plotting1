...
par(mfrow=c(2,2))
plot(input_df$datetime, input_df$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(input_df$datetime, input_df$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(input_df$datetime, input_df$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()